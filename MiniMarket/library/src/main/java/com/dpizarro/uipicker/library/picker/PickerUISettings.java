 ...
 */
public class PickerUISettings<T extends SimpleTitle> implements Parcelable {
    ...
    public List<? extends Title> getItems() {
        return mItems;
    }
    ...
    public static final class Builder<T extends SimpleTitle> {
        ...
        public Builder withItems(List<T> mItems) {
            this.mItems = mItems;
            return this;
        }
