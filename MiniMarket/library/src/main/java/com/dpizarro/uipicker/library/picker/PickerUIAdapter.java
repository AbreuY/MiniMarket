 ...
 */
class PickerUIAdapter<T extends SimpleTitle> extends ArrayAdapter<T> {
     ...
     */
    public PickerUIAdapter(Context context, int resource, List<T> items, int position,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String option = items.get(position).getTitle();
     ...
     */
    void setItems(List<T> rawItems, int position) {
     ...
     */
    private void addEmptyRows(List<T> rawItems) {


        SimpleTitle emptyRow=new SimpleTitle() {
            @Override
            public String getTitle() {
                return "";
            }
        };
        List<T> emptyRows = (List<T>) Arrays.asList(emptyRow, emptyRow);
