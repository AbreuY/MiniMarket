...
import com.dpizarro.uipicker.library.Interfaces.SimpleTitle;
import com.dpizarro.uipicker.library.Interfaces.Title;
...
public class PickerUI extends RelativeLayout implements PickerUIBlurHelper.BlurFinishedListener {
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            try {
                ...
                if (idItems != -1) {
                    List<String> strings = Arrays.asList(getResources().getStringArray(idItems));
     ...
     */
    public void setItems(Context context, List<? extends Title> items) {
        if (items != null) {
     ...
     * @param position the position to set in the center of the panel.
     */
    public void setItems(Context context, List<? extends Title> items, int which, int position) {
        if (items != null) {
            this.items = items;
     ...
     */
    public void setOnClickItemPickerUIListListener(PickerUIListView.PickerUIItemClickListener listener) {
     ...
     */
    public interface PickerUIItemClickListener<T extends SimpleTitle> {
         ...
         */
        public void onItemClickPickerUI(int which, int position, T valueResult);
    }
