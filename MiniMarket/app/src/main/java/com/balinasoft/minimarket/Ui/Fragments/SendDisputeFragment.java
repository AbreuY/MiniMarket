...
import com.balinasoft.minimarket.Ui.Dialogs.DialogFragmentForSelectedPhoto;
import com.balinasoft.minimarket.adapters.AdapterImage;
...
import com.balinasoft.minimarket.networking.Request.RequestOpenDispute;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getService().openDispute(builder.build()).enqueue(new MyCallback<ResponseAnswer>() {
                    @Override
