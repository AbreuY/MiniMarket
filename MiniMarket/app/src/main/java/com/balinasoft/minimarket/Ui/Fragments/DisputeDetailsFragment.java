...
import com.balinasoft.minimarket.Ui.Dialogs.EditTextDialog;
import com.balinasoft.minimarket.Ui.Dialogs.GestureViewDialog;
import com.balinasoft.minimarket.adapters.AdapterDispute;
...
public class DisputeDetailsFragment extends Basefragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            getService().disput(new RequestFullDispute(String.valueOf(idDispute), userListener.getUser().getSession_id(), String.valueOf(userListener.getUser().getId()))).enqueue(new MyCallback<ResponseDisput>() {
                @Override
            ...
            public void onClick(View v) {
                ...
                new EditTextDialog().setTitle(getString(R.string.result)).setClickListener(new EditTextDialog.ClickListener() {
                    ...
                    public void onClick(String message) {
                        ...
                        getService().closeDisput(closeDispute).enqueue(new MyCallback<ResponseAnswer>() {
                            @Override
