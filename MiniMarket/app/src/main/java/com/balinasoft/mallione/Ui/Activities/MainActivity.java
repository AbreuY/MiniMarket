...
public class MainActivity extends AppCompatActivity
        implements ShowFragmentListener, ToolbarListener,ToolbarSettingsListener,Swipeable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipyRefreshLayout=(SwipyRefreshLayout)findViewById(R.id.mainActivity_swipy);
